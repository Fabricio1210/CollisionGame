...
public class EnemyBullets extends MovingObject{

	public EnemyBullets(Vector2D position, Vector2D velocity, double maxVel, double angle, BufferedImage texture, GameState gameState) {
